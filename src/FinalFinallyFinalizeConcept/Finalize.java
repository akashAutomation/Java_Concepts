...
public class Finalize {
	...
	/*
	 * 1. The finalize() method in Java is a special method that belongs to the Object class
	 *    and is used for cleanup operations before an object is garbage collected.
	 * 2. It will automatically call, there is no need to call explicitly
	 ...
	 * 13. You can override it in your class to release resources like closing files, sockets, or database connections.
	 *                       														    
	 */


    @Override
	public void finalize()  { //As of Java 9, it's deprecated. And in Java 18+, it's marked for removal.
